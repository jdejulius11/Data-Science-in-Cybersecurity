...
def main(facility, ix_asns, ix_facility, ixs, pfx2as, output):
	start = time.time()
	...
	prefix_to_as_df = pd.read_csv(pfx2as, delimiter="\t",
...
parser.add_argument("facility", type=str, help="The facility file to read. Ex: If the file is facilities_202207.json, this would be 202207")
parser.add_argument("ix_asns", type=str, help="The ix-asns file to read. Ex: If the file is ix-asns_202210.json, this would be 202210")
parser.add_argument("ix_facility", type=str, help="The ix-facility file to read. Ex: If the file is ix-facilities_202210.json, this would be 202210")
parser.add_argument("ixs", type=str, help="The ixs file to read. Ex: If the file is ixs_202207.json, this would be 202207")
parser.add_argument("pfx2as", type=str, help="The pfx2as file to read. Ex: If the file is outeviews-rv2-20221103-1200.pfx2as, this would be 20221103-1200")
parser.add_argument("-o", "--output", type=str, default="merged_data.csv", help="The file to save to. Defaults to merged_data.csv")
